...
def mock_repo():
    ...
    entity.invoice_number = "sample-invoice_number"
    entity.customer_id = uuid4()
    entity.work_order_id = uuid4()
    entity.status = "draft"
    entity.issue_date = date.today()
    entity.due_date = date.today()
    entity.subtotal = Decimal('10.00')
    entity.tax_amount = Decimal('10.00')
    entity.total_amount = Decimal('10.00')
    entity.currency = "sample-currency"
