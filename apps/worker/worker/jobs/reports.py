...
@shared_task(base=RelayOpsTask, name="worker.jobs.reports.export_work_orders_csv")
...
@shared_task(base=RelayOpsTask, name="worker.jobs.reports.export_sla_breaches")
...
@shared_task(base=RelayOpsTask, name="worker.jobs.reports.technician_utilization")
...
@shared_task(base=RelayOpsTask, name="worker.jobs.reports.inventory_valuation")
