...
@shared_task(base=RelayOpsTask, name="worker.jobs.notifications.send_email")
...
@shared_task(base=RelayOpsTask, name="worker.jobs.notifications.send_sms")
...
@shared_task(base=RelayOpsTask, name="worker.jobs.notifications.process_pending_batch")
...
@shared_task(base=RelayOpsTask, name="worker.jobs.notifications.dispatch_work_order_update")
